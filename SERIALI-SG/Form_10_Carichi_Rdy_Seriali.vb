Public Class Form_10_Carichi_Rdy_Seriali

    Private Sub Carichi_RDY_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DataIns.Value = Date.Now
        DataIns2.Value = Date.Now
    End Sub
    ...
    Private Sub Carichi_RDY_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        Form_00_HOME.Show()
        Me.Hide()
    End Sub
End Class