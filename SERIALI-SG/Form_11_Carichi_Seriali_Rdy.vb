    ...
    Private Sub btnVerifica_Click(sender As Object, e As EventArgs) Handles btnVerifica.Click
        ...
        If righetotali > 0 Then
            For Each riga As Data.DataRow In DSMYSQL.Tables("SERIALI").Rows
                ...
                paginaSeriali += "<table style='font-family: verdana;font-size: 10pt;margin-bottom:5px' width='100%'><tr style='background: cornflowerblue;color: #fff;font-weight: bold;'><td style='border: solid 1px #ccc;padding:5px'>Documento</td><td style='border: solid 1px #ccc;padding:5px'>Fornitore</td><td style='width:80px; text-align:right'>Tot</td></tr>"
                paginaSeriali += "<tr class='Padding'><td style='border: solid 1px #ccc;padding:5px'>" & riga("DOC") & "</td><td style='border: solid 1px #ccc;padding:5px'>" & riga("FORNITORE") & "</td><td style='width:80px; text-align:right;border: solid 1px #ccc;'>" & riga("TOT") & "</td></tr>"
                paginaSeriali += Dettagli(riga("DOC"), riga("FORNITORE")) & "</table>"

                paginaReady = verificaReady(riga("DOC"), Microsoft.VisualBasic.Left(riga("FORNITORE"), 10))

                risultato += "<table id='tableID' style='width:100%;font-family: verdana;font-size: 10pt;margin-bottom:5px'><tr style='vertical-align:top;'>"
